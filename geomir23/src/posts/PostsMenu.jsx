...
export const PostsMenu = () => {
  ...
  return (
    ...
    <button onClick={()=>{ navega("/posts/marks")}}  className={ !qui ? "text-white font-bold py-2 px-4 h-10 md:h-10 bg-orange-500 hover:bg-orange-700" : "text-white font-bold py-2 px-4 h-10 md:h-10 bg-orange-200 hover:bg-orange-700" }>
    Marks
    </button>
